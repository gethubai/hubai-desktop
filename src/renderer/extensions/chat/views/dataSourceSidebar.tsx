...
import { type IActionBarItemProps, type ITreeNodeItemProps } from 'mo/components';
...
export class DataSourceSidebarView extends React.Component {
    ...
    renderCollapse(): ICollapseItem[] {
        const dataSource: DataSourceChatType | undefined = this.state.currentDataSource;
        return [
            {
                id: 'DataSourceList',
                name: 'Active Chats',
    ...
    render() {
        return (
            <div className="dataSource" style={{ width: '100%', height: '100%' }}>
                <Header title={localize('demo.dataSourceManagement', "Chats")} toolbar={
