import { EditorTreeEvent, ExplorerEvent, FileTypes } from '@/model';
import {
  ActivityBarService,
  SidebarService,
  ExplorerService,
...
import { constants, modules } from '@/services/builtinService/const';
...
describe('The explorer controller', () => {
  ...
  test('Should support to execute the onToolbarClick method', () => {
    ...
    mockFn.mockClear();
    expect(mockFn).not.toHaveBeenCalled();
    explorerController.subscribe(ExplorerEvent.onCollapseAllFolders, mockFn);
