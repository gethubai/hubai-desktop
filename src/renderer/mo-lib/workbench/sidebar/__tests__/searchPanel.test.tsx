...
import { replaceBtnClassName } from '@/components/search/base';
import { defaultTreeNodeClassName } from '@/components/tree/base';
...
describe('The SearchPanel Component', () => {
  ...
  test('Should to support to change replace value in controlled', () => {
    ...
    expect(mockToggleModeFn).toHaveBeenCalled();
