...
import { IColors, IColorTheme } from '@hubai/core/';
import { getBuiltInColors } from './colorRegistry';
...
function perfectColors(colors: IColors): IColors {
  ...
  const inheritMap: (
    ...
    ['chat.messageSenderBackground', 'workbenchBackground'],
    ['chat.messageResponseBackground', 'menu.background'],
    ['chat.messageBorder', 'textSeparator.foreground'],
    ['chat.messageAvatarBackground', 'workbenchBackground'],
    ['chat.messageUsernameForeground', 'foreground'],
    ['chat.messageForeground', 'foreground'],
    ['chat.messageAudioBackground', 'input.background'],
    ['chat.messageAudioBarColor', 'textSeparator.foreground'],
    ['chat.messageAudioBarPlayedColor', 'foreground'],
    ['chat.inputSeparator', 'workbenchBackground'],
    ['chat.inputBackground', 'workbenchBackground'],
    ['chat.inputBorder', 'textSeparator.foreground'],
  ];
