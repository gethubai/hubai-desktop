...
import { IColorTheme } from '@hubai/core';
...
const defaultDark = {
  ...
  'statusBar.background': 'rgb(0, 122, 204)',
  'statusBar.foreground': 'rgb(255, 255, 255)',
  'chat.messageSenderBackground': '#252526', // workbenchBackground
  'chat.messageResponseBackground': '#3C3C3C', // menu.background
  'chat.messageBorder': '#ffffff2e', // textSeparator.foreground
  'chat.messageAvatarBackground': '#252526', // workbenchBackground
  'chat.messageUsernameForeground': '#CCCCCC', // foreground
  'chat.messageForeground': '#CCCCCC', // foreground
  'chat.messageAudioBackground': '#3C3C3C', // input.background
  'chat.messageAudioBarColor': '#ffffff2e', // textSeparator.foreground
